...
Az Chloros három alkalmazási módban érhető el:

## Chloros: Asztali GUI alkalmazás

Önálló, külön ablak, minden funkcióval.
...
* **Többszálas feldolgozás**: jelentősen felgyorsítja a nagyobb projektek képfeldolgozását azáltal, hogy a képeket egyszerre dolgozza fel a folyamat során.
* **GPU (CUDA) gyorsítás**: kihasználhatja a mai nagyobb GPU memória opciókat a képfeldolgozási folyamat további felgyorsításához. A legjobb eredmények elérése érdekében 4 GB vagy annál nagyobb VRAM-ot ajánlunk.
...
* **Egyedi multispektrális index képletek:** adjon meg egyedi multispektrális indexeket az Chloros raszter számológépekben, mind a feldolgozáshoz, mind a képnézegető sandboxhoz.
