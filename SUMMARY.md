...
* [Kalibrációs célpontok](calibration-targets.md)
...
* [Projekt beállítások](project-settings/project-settings.md)
* [Multispektrális index képletek](project-settings/multispectral-index-formulas.md)

## KÉPMEGTEKINTŐ (GUI)

* [Képrács](image-viewer-gui/image-grid.md)
...
* [Térképjelölők](image-viewer-gui/map-markers.md)

## Linux és Edge Computing

* [Linux áttekintés](linux/linux-overview.md)
* [Linux telepítés](linux/linux-installation.md)
* [NVIDIA Jetson útmutató](linux/nvidia-jetson-guide.md)

## Feldolgozási architektúra

* [Dinamikus számítási adaptáció](processing-architecture/dynamic-compute-adaptation.md)
* [Feldolgozási folyamat](processing-architecture/processing-pipeline.md)
