...
<summary>Szerkeszthetem a képeimet az Chloros feldolgozása előtt?</summary>

Nem. Az Chloros feltételezi, hogy a bevitt adatok nem lettek módosítva. Ne változtassa meg a fájlneveket.
...
<summary>Az Chloros képes ortomosaik képeket feldolgozni vagy elemezni?</summary>

Nem. Csak az egyes MAPIR kameraképek támogatottak, az ortomosaik térképhez hasonló összerakott képek nem.

</details>

<details>

<summary>Hogyan tudom felgyorsítani az Chloros célfelismerési lépését?</summary>

A fájlböngésző táblázatban a jobb oldali oszlopban előre kiválasztva a célképeket, az Chloros csak ezekben a képekben fogja keresni a kalibrációs célokat, ami jelentősen felgyorsítja a feldolgozást.
...
<summary>Az MAPIR valaha támogatni fogja az X funkciót? Nagyon szeretném, ha az MAPIR kínálná az X funkciót.</summary>

Mindig szívesen fogadjuk termékeinkkel kapcsolatos visszajelzéseket. Ha problémát tapasztal termékeinkkel kapcsolatban, vagy javaslata van arra vonatkozóan, hogyan javíthatnánk termékeinket, kérjük, [VEGYE FEL VELÜNK A KAPCSOLATOT](https://www.mapir.camera/community/contact), és ossza meg velünk gondolatait. Kutatási és fejlesztési tevékenységünk nagy része az ügyfeleink legfontosabb igényeinek figyelembevételén alapul.
