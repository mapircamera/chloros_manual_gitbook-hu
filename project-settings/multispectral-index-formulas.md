...
Az erdős területek alacsonyabb FCI2 értékekkel rendelkeznek, mivel a fák visszaverődése alacsonyabb, és az erdő lombkoronáján belül árnyékok vannak.
...
Ez a nemlineáris vegetációs index műholdas képek alapján globális környezetfigyelésre szolgál, és megkísérli korrigálni a légköri hatásokat. Hasonló az NDVI-hez, de kevésbé érzékeny a légköri hatásokra. Hatással van rá a csupasz talaj, ezért ritkás vagy közepesen sűrű növényzetű területeken nem ajánlott használni.
...
_Hivatkozás: Gitelson, A., Y. Gritz és M. Merzlyak. „A levélklorofill-tartalom és a spektrális visszaverődés közötti kapcsolatok, valamint algoritmusok a magasabb rendű növények leveleinek roncsolásmentes klorofill-értékeléséhez.” Journal of Plant Physiology 160 (2003): 271-282._
...
_Hivatkozás: Sripada, R., et al. „A kukorica szezon közbeni nitrogénigényének meghatározása légi színes infravörös fényképezés segítségével.” Ph.D. disszertáció, Észak-Karolina Állami Egyetem, 2005._
...
_Hivatkozás: Sripada, R. et al. „Légi színes infravörös fényképezés a kukorica szezonbeli korai nitrogénigényének meghatározásához.” Agronomy Journal 98 (2006): 968-977._
...
_Hivatkozás: Boegh, E., H. Soegaard, N. Broge, C. Hasager, N. Jensen, K. Schelde és A. Thomsen. „Légi multispektrális adatok a levélterület-index, a nitrogénkoncentráció és a fotoszintézis hatékonyságának számszerűsítésére a mezőgazdaságban.” Remote Sensing of Environment 81, 2-3. sz. (2002): 179-193._

***

## LCI – Levélklorofill-index

Ezt az indexet a magasabb rendű növények klorofilltartalmának becslésére használják, amely érzékeny a klorofill abszorpciója által okozott visszaverődés változásaira.

$$
LCI = {NIR2 - RedEdge \over NIR2 + Red}
$$

_Hivatkozás: Datt, B. „Eucalyptus levelek víztartalmának távérzékelése.” Journal of Plant Physiology 154, 1. sz. (1999): 30–36._

***

## MNLI – Módosított nemlineáris index

Ez az index a nemlineáris index (NLI) továbbfejlesztése, amely magában foglalja a talajhoz igazított vegetációs indexet (SAVI) a talaj háttérének figyelembevétele érdekében. Az ENVI 0,5-ös értékű lombkorona-háttér-kiigazítási tényezőt (_L_) használ.
...
Ez az index a Qi és társai (1994) által javasolt MSAVI index egyszerűbb változata, amely továbbfejleszti a talajhoz igazított vegetációs indexet (SAVI). Csökkenti a talaj zaját és növeli a vegetációs jel dinamikus tartományát. Az MSAVI2 egy induktív módszeren alapul, amely nem használ állandó _L_ értéket (mint az SAVI) az egészséges vegetáció kiemelésére.
...
_Hivatkozás: Rouse, J., R. Haas, J. Schell és D. Deering. Növényzetrendszerek megfigyelése a Nagy-síkságon az ERTS segítségével. Harmadik ERTS szimpózium, NASA (1973): 309-317._

***

## NLI – nemlineáris index

Ez az index feltételezi, hogy sok vegetációs index és a felszíni biofizikai paraméterek közötti kapcsolat nemlineáris. Lineárissá teszi a nemlineáris tendenciát mutató felszíni paraméterekkel való kapcsolatokat.
...
Ez az index a talajhoz igazított vegetációs indexen (SAVI) alapul. A lombkorona háttér-igazítási tényezőjének standard értékét 0,16-nak veszi. Rondeaux (1996) megállapította, hogy ez az érték alacsony növényzetfedés esetén nagyobb talajváltozást biztosít, mint az SAVI, miközben 50% feletti növényzetfedés esetén nagyobb érzékenységet mutat. Ez az index leginkább olyan területeken használható, ahol a növényzet viszonylag ritka, és a talaj a lombkorona alatt látható.
...
Ez az index hasznos a városi környezet vegetációs fedelmének figyelemmel kíséréséhez. Nem telítődik, mint az NDVI és az SAVI.
...
## VARI – Látható légköri ellenálló index
...
Ez az index hasonló az NDVI-hez, de súlyozási együtthatót (_a_) használ, hogy csökkentse a közeli infravörös és a vörös jelek hozzájárulásának eltérését az NDVI-hez. Az WDRVI különösen hatékony olyan jelenetekben, ahol a növényzet sűrűsége közepes vagy magas, és az NDVI meghaladja a 0-t.6. Az NDVI általában kiegyenlítődik, amikor a növényzet aránya és a levélfelületi index (LAI) növekszik, míg az WDRVI érzékenyebb a növényzet arányának szélesebb tartományára és az LAI változásaira.
...
_Gitelson, A. „Wide Dynamic Range Vegetation Index for Remote Quantification of Biophysical Characteristics of Vegetation” (Széles dinamikus tartományú vegetációs index a vegetáció biofizikai jellemzőinek távoli számszerűsítéséhez). Journal of Plant Physiology 161, 2. szám (2004): 165–173._
